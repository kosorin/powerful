...
function helper_client.get_distance(client, coords)
    local x, y
...
function helper_client.find_closest(clients, coords)
    ...
    for i = 1, client_count do
        ...
        local distance = helper_client.get_distance(client, coords)
