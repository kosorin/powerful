...
local help = {
    default_labels = {
        ...
        [btn.wheel_up]        = mouse_label_icon .. " Scroll Up",
        [btn.wheel_down]      = mouse_label_icon .. " Scroll Down",
        [btn.wheel_left]      = mouse_label_icon .. " Scroll Left",
        [btn.wheel_right]     = mouse_label_icon .. " Scroll Right",
